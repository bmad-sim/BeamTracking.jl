...
- 'beta_strong':   normalized velocity of strong beam
"""
@makekernel fastgtpsa = true function exact_beambeam!(i, coords::Coords, p0c, charge,
	beta_0, tilde_m,
	sig_x_strong, sig_y_strong, sig_z_strong, N_particles,
	n_slices, z_offset, beta_strong)
	v = coords.v
