...
function linear_universal!(
  ...
  if !isactive(bmultipoleparams) # Drift
    ...
    kc = BeamTracking.push(kc, KernelCall(LinearTracking.linear_drift!, (L, L/gamma_0^2)))
  ...
  elseif haskey(bmultipoleparams.bdict, 0) # Solenoid
    ...
    kc = BeamTracking.push(kc, KernelCall(LinearTracking.linear_coast!, (mxy, L/gamma_0^2, nothing, nothing)))
  ...
  elseif haskey(bmultipoleparams.bdict, 1) # Bend
    ...
    kc = BeamTracking.push(kc, KernelCall(LinearTracking.linear_coast_uncoupled!, (mx, my, r56, d, t)))
  ...
  elseif haskey(bmultipoleparams.bdict, 2) # Quadrupole
    ...
    kc = BeamTracking.push(kc, KernelCall(LinearTracking.linear_coast_uncoupled!, (mx, my, L/gamma_0^2, nothing, nothing)))
  ...
  #@show kc
  runkernels!(nothing, kc, v, work; kwargs...)
