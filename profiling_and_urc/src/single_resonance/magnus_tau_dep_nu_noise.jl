...
include("single_resonance_magnus_6_nu_noise.jl")
...
for i = 1:measurements
    ...
    spin_sum = [0, 0, 0]
    if (i > 1)
        @cuda threads = threads blocks = blocks single_resonance_track_magnus_6_nu_noise(Y_dev, R_dev, nu0, sigma0, beta, epsilon, delta, steps_per_measurement, true_dt)
...
# savefig("polarizations_$dt" * "_$orbits" * "_$n_particles" * "_$nu0" * "_ISF.png")
writedlm("nu_scan_noise/polarizations_$dt" * "_$orbits" * "_$n_particles" * "_$nu0" * "_delta$delta" * "_ISF.txt", all_polarizations)
