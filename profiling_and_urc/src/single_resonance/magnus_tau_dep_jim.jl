...
include("single_resonance_magnus_6_jim.jl")
...
for i = 1:measurements
    ...
    spin_sum = [0, 0, 0]
    if (i > 1)
        @cuda threads = threads blocks = blocks single_resonance_track_magnus_6_jim(Y_dev, R_dev, nu0, sigma0, beta, epsilon, steps_per_measurement, true_dt)
...
writedlm("nu_scan_jim/polarizations_$dt" * "_$orbits" * "_$n_particles" * "_$nu0" * "_jimISF.txt", all_polarizations)