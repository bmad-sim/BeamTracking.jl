@testset "Yoshida" begin
  @testset "Kernels" begin
    ...
    function mk_args(::Type{T}) where {T}
      ...
      gamsqr_0 = 1 + 1/tilde_m^2
      beta_0 = 1/sqrt(1 + tilde_m^2)
      return T(0), nothing, beta_0, gamsqr_0, tilde_m, a, w, w_inv, k1, mm, kn, ks, L
    end
    ...
    function dk_args(::Type{T}) where {T}
      ...
      gamsqr_0 = 1 + 1/tilde_m^2
      beta_0 = 1/sqrt(1 + tilde_m^2)
      return T(0), nothing, beta_0, gamsqr_0, tilde_m, a, mm, kn, ks, L
    end
    ...
    test_map("bmad_maps/order_four.jl", make_kernel_call(BeamTracking.order_four_integrator!, integrator_args(Float64)); tol=5e-10, no_scalar_allocs=true)
    ...
    test_map("bmad_maps/order_four.jl", make_kernel_call(BeamTracking.order_four_integrator!, integrator_args(TPS64{D10})); tol=5e-10)
