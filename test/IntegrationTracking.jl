@testset "SplitIntegration" begin
  @testset "Kernels" begin
    ...
    function sk_args(::Type{T}) where {T}
      ...
      return beta_0, gamsqr_0, tilde_m, 1/tilde_m, ELECTRON.anom, Ksol, mm, kn, sn, L
    end
    ...
    function mk_args(::Type{T}) where {T}
      ...
      gamsqr_0 = 1 + 1/tilde_m^2
      beta_0 = 1/sqrt(1 + tilde_m^2)
      return beta_0, gamsqr_0, tilde_m, 1/tilde_m, ELECTRON.anom, w, w_inv, k1, mm, kn, ks, L
    end
    ...
    function dk_args(::Type{T}) where {T}
      ...
      gamsqr_0 = 1 + 1/tilde_m^2
      beta_0 = 1/sqrt(1 + tilde_m^2)
      return beta_0, gamsqr_0, tilde_m, 1/tilde_m, ELECTRON.anom, mm, kn, ks, L
    end
    ...
    function integrator_args(::Type{T}) where {T}
      ...
      gamsqr_0 = 1 + 1/tilde_m^2
      beta_0 = 1/sqrt(1 + tilde_m^2)
      params = (beta_0, gamsqr_0, tilde_m, 1/tilde_m, ELECTRON.anom, mm, kn, ks)
