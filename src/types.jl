...
function Bunch(;
  ...
  weight=nothing,
  callbacks=(),
  p_over_q_ref=TPSAInterface.numtype(eltype(v))(NaN), 
  t_ref=zero(TPSAInterface.numtype(eltype(v))), 
  species=Species(),
)
...
function Bunch(v::AbstractMatrix, q=nothing, weight=nothing; p_over_q_ref=TPSAInterface.numtype(eltype(v))(NaN), t_ref=zero(TPSAInterface.numtype(eltype(v))), species=Species(), callbacks=())
...
function Bunch(v::AbstractVector, q=nothing, weight=nothing; p_over_q_ref=TPSAInterface.numtype(eltype(v))(NaN), t_ref=zero(TPSAInterface.numtype(eltype(v))), species=Species(), callbacks=())
