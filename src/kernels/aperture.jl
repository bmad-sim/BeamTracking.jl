@makekernel inbounds=false fastgtpsa=true function track_aperture_rectangular!(i, coords::Coords, x1, x2, y1, y2)
  v = coords.v
...
@makekernel inbounds=false fastgtpsa=true function track_aperture_elliptical!(i, coords::Coords, x1, x2, y1, y2)
  v = coords.v
